const Sidebar = ({ categories = [], selectedCategory = "All", onCategoryChange }) => {
  return (
    <aside className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm sm:rounded-[2rem] sm:p-5 lg:sticky lg:top-28">
      ...
      <div className="flex flex-wrap gap-2 pb-1 lg:flex-col lg:gap-3 lg:overflow-visible">
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`rounded-xl px-3 py-2 text-left text-xs font-medium transition sm:rounded-2xl sm:px-4 sm:py-3 sm:text-sm lg:w-full ${
                isActive
